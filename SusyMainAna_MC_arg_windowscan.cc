	// -*- C++ -*-
#define SusyMainAna_MC_arg_windowscan_cxx
...
#include "SusyMainAna_MC_arg_windowscan.h"
...
void SusyMainAna_MC_arg_windowscan::InitializePerEvent() {
	
}


bool SusyMainAna_MC_arg_windowscan::isSameObject(TLorentzVector& p1, TLorentzVector& p2) {
...
float SusyMainAna_MC_arg_windowscan::d0correction(TVector3& beamSpot, susy::Track& track) const {
	return track.d0() - beamSpot.X()*std::sin(track.phi()) + beamSpot.Y()*std::cos(track.phi());
}


bool SusyMainAna_MC_arg_windowscan::PassTrigger(TString path) {
...
bool SusyMainAna_MC_arg_windowscan::PassTriggers() {
	bool pass = false;
...
void SusyMainAna_MC_arg_windowscan::Loop(string which_MC_to_use) {
	printLevel = 0;
	...
	TFile* fout = new TFile(thisMCpoint->plotsroot_mc.c_str(),"RECREATE");
	fout->cd();
	ofstream logfile;
	logfile.open(thisMCpoint->logplotsroot_mc.c_str());
	...
	hmin["MET"] = 0.f;
	hmax["MET"] = 150.f;
	titles["MET"] =  "Missing Transverse Energy";
	xlabels["MET"] = "#slash{E}_{T} (GeV)";

	nbins["ST"] = 30; 
	hmin ["ST"] = 0.f;
	hmax ["ST"] = 1500.f;
	titles["ST"] =  "Scalar Sum of all Calorimeter Energy";
	xlabels["ST"] = "#SigmaE_{T} (GeV)";

	nbins["HT"] = 20.f;
	hmin ["HT"] = 0.f;
	hmax ["HT"] = 1000.f;
	titles["HT"] =  "Scalar Sum of all Hadronic Transverse Energy";
	xlabels["HT"] = "#SigmaH_{T} (GeV)";

	nbins["LHT"] = 20.f;
	hmin ["LHT"] = 0.f;
	hmax ["LHT"] = 1000.f;
	titles["LHT"] =  "Scalar Sum of Light Hadronic Transverse Energy";
	xlabels["LHT"] = "#SigmaH_{T} (GeV)";

        nbins["Bt"] = 20.f;
        hmin ["Bt"] = 0.f;
        hmax ["Bt"] = 800.f;
	titles["Bt"] =  "Scalar Sum of all B-jet Transverse Energy";
        xlabels["Bt"] = "#SigmaB_{T} (GeV)";

        nbins["BTL"] = 20.f;
        hmin ["BTL"] = 0.f;
        hmax ["BTL"] = 800.f;
	titles["BTL"] =  "Scalar Sum of Exclusively Loose B-jet Transverse Energy";
        xlabels["BTL"] = "#SigmaB_{T} (GeV)";

        nbins["BTM"] = 20.f;
        hmin ["BTM"] = 0.f;
        hmax ["BTM"] = 800.f;
	titles["BTM"] =  "Scalar Sum of Exclusively Medium B-jet Transverse Energy";
        xlabels["BTM"] = "#SigmaB_{T} (GeV)";

        nbins["BTT"] = 20.f;
        hmin ["BTT"] = 0.f;
        hmax ["BTT"] = 800.f;
	titles["BTT"] =  "Scalar Sum of B-jeusively Tight Transverse Energy";
        xlabels["BTT"] = "#SigmaB_{T} (GeV)";

	nbins["MHT"] = 20.f;
	hmin ["MHT"] = 0.f;
	hmax ["MHT"] = 250.f;
	titles["MHT"] =  "Missing Transverse Hadronic Energy";
	xlabels["MHT"] = "#slashH_{T} (GeV)";

	nbins["LepT"] = 20.f;
	hmin ["LepT"] = 0.f;
	hmax ["LepT"] = 150.f;
	titles["LepT"] =  "Leptonic Transverse Energy";
	xlabels["LepT"] = "Lep #sigmaE_{T} (GeV)";
		//Pt's
	nbins["PtGG"] = 25.;//somewhere you're rebin(5) this
	hmin ["PtGG"] = 0.f;
	hmax ["PtGG"] = 250.f;
	titles["PtGG"] =  "Di-Photon Pt Sectrum";
	xlabels["PtGG"] = "P_{t}^{#gamma #gamma} (GeV)";

	nbins["phoPt0"] = 30;
	hmin ["phoPt0"] = 0.f;
	hmax ["phoPt0"] = 180;
	titles["phoPt0"] =  "";
	xlabels["phoPt0"] = "P_{t}^{#gamma0} (GeV)";

	nbins["phoPt1"] = 30;
	hmin ["phoPt1"] = 0.f;
	hmax ["phoPt1"] = 90;
	titles["phoPt1"] =  "";
	xlabels["phoPt1"] = "P_{t}^{#gamma1} (GeV)";
		//phis
	/*nbins["PhiGG"] = 18;
	hmin ["PhiGG"] = 0.f;
	hmax ["PhiGG"] = 6.2832;
	titles["PhiGG"] =  "Phi of the di-photon system";
	xlabels["PhiGG"] = "#phi^{#gamma #gamma}";*/

	nbins["phoPhi"] = 18;
	hmin ["phoPhi"] = 0.f;
	hmax ["phoPhi"] = 6.2832;
	titles["phoPhi"] =  "";
	xlabels["phoPhi"] = "#phi^{#gamma}";

	/*nbins["phoPhi1"] = 18;
	hmin ["phoPhi1"] = 0.f;
	hmax ["phoPhi1"] = 6.2832;
	titles["phoPhi1"] =  "";
	xlabels["phoPhi1"] = "#phi^{#gamma1}";*/

/*	nbins["EtaGG"] = 26;
	hmin ["EtaGG"] = -2.6;
	hmax ["EtaGG"] = 2.6;
	titles["EtaGG"] =  "Eta of the di-photon system";
	xlabels["EtaGG"] = "#eta^{#gamma #gamma}";*/

	nbins["phoEta"] = 26;
	hmin ["phoEta"] = -2.6;
	hmax ["phoEta"] = 2.6;
	titles["phoEta"] =  "";
	xlabels["phoEta"] = "#eta^{#gamma0}";

	/*nbins["phoEta1"] = 26;
	hmin ["phoEta1"] =-2.6;
	hmax ["phoEta1"] = 2.6;
	titles["phoEta1"] =  "";
	xlabels["phoEta1"] = "#eta^{#gamma1}";*/

	nbins["phoEtaMax"] = 13;
	hmin ["phoEtaMax"] =0.0;
	hmax ["phoEtaMax"] = 2.6;
	titles["phoEtaMax"] =  "Max Eta of the Two Photons";
	xlabels["phoEtaMax"] = "Max #eta^{#gamma}";

	nbins["phoEtaMin"] = 13;
	hmin ["phoEtaMin"] =0.0;
	hmax ["phoEtaMin"] = 2.6;
	titles["phoEtaMin"] =  "Min Eta of the Two Photons";
	xlabels["phoEtaMin"] = "Min #eta^{#gamma}";

	nbins["phoDEta"] = 13;
	hmin ["phoDEta"] = 0.0f;
	hmax ["phoDEta"] = 2.6;
	titles["phoDEta"] =  "";
	xlabels["phoDEta"] = "#Delta #eta^{#gamma #gamma}";

	nbins["phoMinR9"] = 30;
	hmin ["phoMinR9"] =0.4;
	hmax ["phoMinR9"] = 1.0;
	titles["phoMinR9"] =  "Min R9 of the Two Photons";
	xlabels["phoMinR9"] = "Min R9";

	nbins["nJets"] = 15;
	hmin ["nJets"] = 0.f;
	hmax ["nJets"] = 15;
	titles["nJets"] =  "";
	xlabels["nJets"] = "Number of Jets";

	nbins["nBjets"] = 5;
	hmin ["nBjets"] = 0.f;
	hmax ["nBjets"] = 5;
	titles["nBjets"] =  "";
	xlabels["nBjets"] = "Number of B-jets";

	nbins["bestMjj"] = 30;
	hmin ["bestMjj"] = 0.f;
	hmax ["bestMjj"] = 225;
	titles["bestMjj"] =  "";
	xlabels["bestMjj"] = "Closet dijet mass to M_{H}";

	nbins["bestMbb"] = 30;
	hmin ["bestMbb"] = 0.f;
	hmax ["bestMbb"] = 225;
	titles["bestMbb"] =  "";
	xlabels["bestMbb"] = "Closet di-B-jet mass to M_{H}";

        nbins["allMjj"] = 30;
        hmin ["allMjj"] = 0.f;
        hmax ["allMjj"] = 225;
        titles["allMjj"] =  "";
        xlabels["allMjj"] = "All combinations of dijet mass";

        nbins["allMbb"] = 30;
        hmin ["allMbb"] = 0.f;
        hmax ["allMbb"] = 225;
        titles["allMbb"] =  "";
        xlabels["allMbb"] = "All combinations of di-B-jet mass";

	nbins["nLep"] = 6;
	hmin ["nLep"] = 0.f;
	hmax ["nLep"] = 6;
	titles["nLep"] =  "";
	xlabels["nLep"] = "Number of Leptons";

	nbins["nMu"] = 5;
	hmin ["nMu"] = 0.f;
	hmax ["nMu"] = 5;
	titles["nMu"] =  "";
	xlabels["nMu"] = "Number of Muons";

	nbins["nEle"] = 5;
	hmin ["nEle"] = 0.f;
	hmax ["nEle"] = 5;
	titles["nEle"] =  "";
	xlabels["nEle"] = "Number of Electrons";

        nbins["Mleplep"] = 30;
        hmin ["Mleplep"] = 0.f;
        hmax ["Mleplep"] = 120;
        titles["Mleplep"] =  "";
        xlabels["Mleplep"] = "M_{dileptons}";

	nbins["MTphoMET"] = 30;
	hmin ["MTphoMET"] = 0.f;
	hmax ["MTphoMET"] = 300.f;
	titles["MTphoMET"] =  "";
	xlabels["MTphoMET"] = "M_{t}^{#gamma0 MET} (GeV)";

	/*nbins["MTpho1MET"] = 30;
	hmin ["MTpho1MET"] = 0.f;
	hmax ["MTpho1MET"] = 300.0;
	titles["MTpho1MET"] =  "";
	xlabels["MTpho1MET"] = "M_{t}^{#gamma1 MET} (GeV)";*/

	nbins["cosThetaStar"] = 10;
	hmin ["cosThetaStar"] = 0.0f;
	hmax ["cosThetaStar"] = 1.0;
	titles["cosThetaStar"] =  "Cos of angle between the two Photons in their center of mass frame"; //isn't this -1 by definition?
	...
	hmax ["phoDPhi"] = 3.1416;
	titles["phoDPhi"] =  "";
	xlabels["phoDPhi"] = "#Delta#phi(#gamma #gamma)";

	nbins["dPhiPhoMet"] = 12;
	hmin ["dPhiPhoMet"] = 0.f;
	hmax ["dPhiPhoMet"] = 3.1416;
	titles["dPhiPhoMet"] =  "";
	xlabels["dPhiPhoMet"] = "#Delta#phi(#gamma0, #slash{E}_{T})";

	/*nbins["dPhiPho1Met"] = 12;
	hmin ["dPhiPho1Met"] = 0.f;
	hmax ["dPhiPho1Met"] = 3.1416;
	titles["dPhiPho1Met"] =  "";
	xlabels["dPhiPho1Met"] = "#Delta#phi(#gamma1, #slash{E}_{T})";*/

	/*nbins["PitGG"] = 20;//if you change it, make 0.6 a bin bound.
	hmin ["PitGG"] = 0.f;
	hmax ["PitGG"] = 2.f;
	titles["PitGG"] =  "";
	xlabels["PitGG"] = "#Pi_{t}";*/
	...
	hmax ["jetPt"] = 240.f;
	titles["jetPt"] =  "";
	xlabels["jetPt"] = "Jet P_{t} (GeV)";

	nbins["jetPhi"] = 10;
	hmin ["jetPhi"] = 0.f;
	hmax ["jetPhi"] = 6.2832;
	titles["jetPhi"] =  "";
	xlabels["jetPhi"] = "Jet #phi";

	nbins["jetEta"] = 26;
	hmin ["jetEta"] =-2.6;
	hmax ["jetEta"] = 2.6;
	titles["jetEta"] =  "";
	xlabels["jetEta"] = "Jet #eta";

	nbins["dPhiJetMet"] = 12;
	hmin ["dPhiJetMet"] = 0.f;
	hmax ["dPhiJetMet"] = 3.1416;
	titles["dPhiJetMet"] =  "";
	xlabels["dPhiJetMet"] = "#Delta#phi(Jet #slash{E}_{t})";

	/*nbins["dPhiJet0Met"] = 12;
	hmin ["dPhiJet0Met"] = 0.f;
	hmax ["dPhiJet0Met"] = 3.14159;
	titles["dPhiJet0Met"] =  "";
	xlabels["dPhiJet0Met"] = "#Delta#phi(Jet0 #slash{E}_{t})";

	nbins["dPhiJet1Met"] = 12;
	hmin ["dPhiJet1Met"] = 0.f;
	hmax ["dPhiJet1Met"] = 3.14159;
	titles["dPhiJet1Met"] =  "";
	xlabels["dPhiJet1Met"] = "#Delta#phi(Jet1 #slash{E}_{t})";*/

	nbins["dijetDEta01"] = 14;
	hmin ["dijetDEta01"] = 0.0;
	hmax ["dijetDEta01"] = 3.5;
	titles["dijetDEta01"] =  "";
	xlabels["dijetDEta01"] = "#Delta#eta^{J J}";

	/*nbins["dijetEta01"] = 28;
	hmin ["dijetEta01"] = -3.5;
	hmax ["dijetEta01"] = 3.5;
	titles["dijetEta01"] =  "";
	xlabels["dijetEta01"] = "#eta^{J J}";*/

        nbins["dijetDPhi01"] = 12;
        hmin ["dijetDPhi01"] = 0.f;
        hmax ["dijetDPhi01"] = 3.1416;
        titles["dijetDPhi01"] =  "";
        xlabels["dijetDPhi01"] = "#Delta#phi(J0 J1)";

        /*nbins["dijetDR01"] = 25;
        hmin ["dijetDR01"] = 0.f;
        hmax ["dijetDR01"] = 5.0;
        titles["dijetDR01"] =  "";
        xlabels["dijetDR01"] = "dR^{J0 J1}";*/

	nbins["dijetPt01"] = 15;
	hmin ["dijetPt01"] = 0.f;
	hmax ["dijetPt01"] = 300.f;
	titles["dijetPt01"] =  "";
	xlabels["dijetPt01"] = "P_{t}^{J J} (GeV)";

	nbins["dijetM01"] = 20;
	hmin ["dijetM01"] = 0.f;
	hmax ["dijetM01"] = 400.f;
	titles["dijetM01"] =  "Mass of the leading two dijets";
	xlabels["dijetM01"] = "M^{J J} (GeV)";

	nbins["Mbb01"] = 30;
	hmin ["Mbb01"] = 0.f;
	hmax ["Mbb01"] = 225.f;
	titles["Mbb01"] =  "Mass of the leading bb System";
	xlabels["Mbb01"] = "M^{b0 b1} (GeV)";

	nbins["Mbb01gg01"] = 30;
	hmin ["Mbb01gg01"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["Mbb01gg01"] = 990.f;
	titles["Mbb01gg01"] =  "Mass of the leading bb and h->gg System";
	xlabels["Mbb01gg01"] = "M^{b0 b1 #gamma0 #gamma1} (GeV)";

	nbins["MJJ01gg01"] = 30;
	hmin ["MJJ01gg01"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["MJJ01gg01"] = 990.f;
	titles["MJJ01gg01"] =  "Mass of the leading two jets and h->gg System";
	xlabels["MJJ01gg01"] = "M^{J0 J1 #gamma0 #gamma1} (GeV)";

	nbins["MZllHgg"] = 30;
	hmin ["MZllHgg"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["MZllHgg"] = 990.f;
	titles["MZllHgg"] =  "Mass of Z-like dilepton and H like diphoton";
	xlabels["MZllHgg"] = "M^{lep lep #gamma0 #gamma1} (GeV)";

	nbins["MTggMET"] = 30;
	hmin ["MTggMET"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["MTggMET"] = 300.f;
	titles["MTggMET"] =  "Transverse Mass di-photon system and MET";
	xlabels["MTggMET"] = "M^{t}(#gamma0 #gamma1 + MET) (GeV)";

	nbins["MTlepMET"] = 30;
	hmin ["MTlepMET"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["MTlepMET"] = 300.f;
	titles["MTlepMET"] =  "Mass of the leading bb and h->gg System";
	xlabels["MTlepMET"] = "M^{t}(lep,MET) (GeV)";

	nbins["HGt"] = 30;
	hmin ["HGt"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["HGt"] = 300.f;
	titles["HGt"] =  "Hadronic and Photon01 Transverse Energy";
	xlabels["HGt"] = "HG_{t} (GeV)";

	nbins["HGt_prime"] = 30;
	hmin ["HGt_prime"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["HGt_prime"] = 300.f;
	titles["HGt_prime"] = "Hadronic and Photon01 Transverse Energy, from lep+MET";
	xlabels["HGt_prime"] = "HG'_^{t} (GeV)";

	nbins["dPhiHG"] = 12;
	hmin ["dPhiHG"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["dPhiHG"] = 3.1416f;
	titles["dPhiHG"] =  "Delta Phi between gg and All Jets";
	xlabels["dPhiHG"] = "#Delta Phi(Jets,#gamma0 #gamma1) (GeV)";

	nbins["dPhiHG_prime"] = 12;
	hmin ["dPhiHG_prime"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["dPhiHG_prime"] = 3.1416f;
	titles["dPhiHG_prime"] =  "Mass of the leding bb and h->gg System, from lep+MET";
	xlabels["dPhiHG_prime"] = "#Delta Phi(Jets,#gamma0 #gamma1) (GeV)";

	nbins["HLMGt"] = 30;
	hmin ["HLMGt"] = 0.f;//expect broad peak at 176 and a maximum of 
	hmax ["HLMGt"] = 300.f;
	titles["HLMGt"] =  "Transverse Energy of all Objects and MET";
	xlabels["HLMGt"] = "Pt(all particles and met) (GeV)";
	...
	for (int iTopo = 0; iTopo<nEventTopologies; iTopo++) {
		...
		for (int kKinVar = 0; kKinVar<nKinemVars_all; kKinVar++) {
			...
			tmpMapKinVar[s_KinemVars_all[kKinVar]] = new TH1F(
				  ...
				  (char*)(titles[s_KinemVars_all[kKinVar]]+s_forTopo[iTopo]+";"+xlabels[s_KinemVars_all[kKinVar]]).c_str(),
				  nbins[s_KinemVars_all[kKinVar]],
				  hmin[s_KinemVars_all[kKinVar]],
				  hmax[s_KinemVars_all[kKinVar]]);
...
//		std::vector<susy::Photon*>   tap_electrons;
	...
	//	that messes with the address of the start of the vector. 
		...
		if ((*p_photonVector).size()>=2 ){
			...
			if (Et0 >= phoEtThresh0){ // if ((*p_photonVector)[0]->momentum.Et() >= phoEtThresh0){
				...
				if ((*p_photonVector).size()>2 && Et1 >= phoEtThresh1) //if ((*p_photonVector).size()>2 && (*p_photonVector)[1]->momentum.Et() >= phoEtThresh1)
					pho_Et_2->Fill( useMVAphoP?(*p_photonVector)[2]->MVAcorrMomentum.Et():(*p_photonVector)[2]->momentum.Et() ); //pho_Et_2->Fill((*p_photonVector)[2]->momentum.Et()); 
			}
		}
		...
		if ((*p_photonVector).size()<2 || 
			...
			//if(printLevel > 0 && event->eventNumber == ((unsigned int)probeevent)) cout<<"probe passes Two Tight Photons"<<endl;
...
//				int np=0;
				for(std::vector<susy::Photon*>::iterator p_it = (*p_photonVector).begin(); p_it != (*p_photonVector).end(); p_it++) {
//					if (np >=2) break;
					same_pho_object |= isSameObject(corrP4,useMVAphoP?(*p_it)->MVAcorrMomentum:(*p_it)->momentum ); //same_pho_object |= isSameObject(corrP4,(*p_it)->momentum);
//					np++;
				}
		...
		MHT_all = std::sqrt(MHT_x_all*MHT_x_all + MHT_y_all*MHT_y_all);
			...
			//////////////////////// FIND B-JETS  ///////////////////////////
			/////////////////////////////////////////////////////////////////
		if(printLevel > 4) std::cout << "Start looking at B'jets" << std::endl;
...
//		bool Pi6 = ptgg/mgg>0.6;
		...
		float MZllHgg = -1.0;
		float MTlepMET = -1.0;
		if(printLevel > 3) std::cout << "boo2" << std::endl;
		if(Muons.size() >=1){
		...
		if(printLevel > 3) std::cout << "boo3" << std::endl;
...
//		printf("csgg afterB: E %.1f P %.1f Px %.1f Py %.1f Pz %.1f\n",csgg.E(),csgg.P(),csgg.Px(),csgg.Py(),csgg.Pz());
		...
		if(printLevel > 3) std::cout << "boo4" << std::endl;
               if(printLevel > 0 && event->eventNumber == ((unsigned int)probeevent)){
...
/*		topoCut["2Jm20"] =       nJ >=2 && corrmet >20.0;
		...
		topoCut["2JbMLm20gbar1"] =    nJ >=2 && nbL >=2 && nbM >=1 && corrmet >20.0 && onePhoBar;
		m_BTagWeight["2JbMLm20gbar1"] = new BTagWeight(3,2,bTagRequirement_ML);
		...
		topoCut["2JbML!m20Gbar2Mbb"] =    nJ >=2 && nbL ==2 && nbM >=1 && corrmet >20.0 && twoPhoBar && Mbb01_is_H;
		m_BTagWeight["2JbML!m20Gbar2Mbb"] = new BTagWeight(3,2,bTagRequirement_ML,bTypeExactLoose);

		topoCut["2JbML!m20Gbar2Mbb!"] =    nJ >=2 && nbL ==2 && nbM >=1 && corrmet >20.0 && twoPhoBar && !Mbb01_is_H;
		m_BTagWeight["2JbML!m20Gbar2Mbb!"] = new BTagWeight(3,2,bTagRequirement_ML,bTypeExactLoose);

		topoCut["3JbMLLm20Gbar2"] =    nJ >=3 && nbL >=3 && nbM >=1 && corrmet >20.0 && twoPhoBar;
		m_BTagWeight["3JbMLLm20Gbar2"] = new BTagWeight(3,3,bTagRequirement_MLL);

		topoCut["4JbMLLLm20Gbar2"] =    nJ >=4 && nbL >=4 && nbM >=1 && corrmet >20.0 && twoPhoBar;
		m_BTagWeight["4JbMLLLm20Gbar2"] = new BTagWeight(3,4,bTagRequirement_MLLL);
		...
		topoCut["2JbTLm20gbar2"] =    nJ >=2 && nbL >=2 && nbT >=1 && corrmet >20.0 && twoPhoBar;
		m_BTagWeight["2JbTLm20gbar2"] = new BTagWeight(3,2,bTagRequirement_TL);
		...
		topoCut["2JbMLm20gbar2Tpho"] = topoCut["Tpho"] && topoCut["2JbMLm20gbar2"];
		m_BTagWeight["2JbMLm20gbar2Tpho"] = new BTagWeight(3,2,bTagRequirement_ML);
		topoCut["1lepTpho"] = topoCut["Tpho"] &&  topoCut["1lep"];
                m_BTagWeight["1lepTpho"] = new BTagWeight(3,0,bTagRequirement_NULL);
		topoCut["2lepTpho"] = topoCut["Tpho"] &&  topoCut["2lep"];
		...
		for (int iTopo=0; iTopo<nEventTopologies; iTopo++) {
			if(topoCut[s_EventTopology[iTopo]]){
				...
				//I checked these by hand, they come out as expected!!
				//cout<<s_EventTopology[iTopo]<<" weight "<<weight<<endl;

				if(printLevel > 0) std::cout << "topo: "<<s_EventTopology[iTopo] << std::endl;
				...
				lh_unsliced[s_EventTopology[iTopo]]["phoPt1"]->Fill(p1.Pt(),weight);
				lh_unsliced[s_EventTopology[iTopo]]["phoPhi"]->Fill(phi_0_2pi(p0.Phi()),weight);
				lh_unsliced[s_EventTopology[iTopo]]["phoPhi"]->Fill(phi_0_2pi(p1.Phi()),weight);
				...
				for(int i=0;i<tempsize-1;i++){
					for(int j=i+1; j<tempsize;j++){
						lh_unsliced[s_EventTopology[iTopo]]["allMjj"]->Fill((ra3_pfjets[i]->momentum+ra3_pfjets[j]->momentum).M(),weight); } }
				...
				if(nLep >=2 ){
					lh_unsliced[s_EventTopology[iTopo]]["Mleplep"]->Fill(Mleplep,weight);
					lh_unsliced[s_EventTopology[iTopo]]["MZllHgg"]->Fill(MZllHgg,weight);
				}
				for(std::vector<susy::PFJet*>::iterator it = ra3_pfjets.begin(); it != ra3_pfjets.end(); it++) { 
//					if((*it)->bTagDiscriminators[5] > 0.679) pfBJetsMedium.push_back(*it);//CSV medium working point
//					selvar_btag_csv->Fill((*it)->bTagDiscriminators[5],weight);					lh_unsliced[s_EventTopology[iTopo]]["jetEta"]->Fill((*it)->momentum.Eta(),weight);
					lh_unsliced[s_EventTopology[iTopo]]["jetPt"]->Fill((*it)->momentum.Pt(),weight);//
					lh_unsliced[s_EventTopology[iTopo]]["jetEta"]->Fill((*it)->momentum.Eta(),weight);
					lh_unsliced[s_EventTopology[iTopo]]["jetPhi"]->Fill(phi_0_2pi((*it)->momentum.Phi() ),weight);//
					lh_unsliced[s_EventTopology[iTopo]]["dPhiJetMet"]->Fill(phi_0_2pi(dPhi(metPhi,(*it)->momentum.Phi() )),weight);//
				}
				if (ra3_pfjets.size()>=2) {
					...
					//lh_unsliced[s_EventTopology[iTopo]]["dPhiJet0Met"]->Fill(phi_0_2pi(dPhi(metPhi,j0.Phi() )),weight);//
					//lh_unsliced[s_EventTopology[iTopo]]["dPhiJet1Met"]->Fill(phi_0_2pi(dPhi(metPhi,j1.Phi() )),weight);//

					lh_unsliced[s_EventTopology[iTopo]]["Mbb01"]->Fill(Mbb01,weight);
					lh_unsliced[s_EventTopology[iTopo]]["Mbb01gg01"]->Fill(Mbb01gg01,weight);
					lh_unsliced[s_EventTopology[iTopo]]["MJJ01gg01"]->Fill(MJJ01gg01,weight);
				...
				if(passmass){
					if (mgg > lsb_lb && mgg < lsb_ub) { // lower side band
						...
						lha2[s_EventTopology[iTopo]]["phoPt1"][0]->Fill(p1.Pt(),weight);
						lha2[s_EventTopology[iTopo]]["phoPhi"][0]->Fill(phi_0_2pi(p0.Phi()),weight);
						lha2[s_EventTopology[iTopo]]["phoPhi"][0]->Fill(phi_0_2pi(p1.Phi()),weight);
						...
						for(int i=0;i<tempsize-1;i++){
							for(int j=i+1; j<tempsize;j++){
								lha2[s_EventTopology[iTopo]]["allMjj"][0]->Fill((ra3_pfjets[i]->momentum+ra3_pfjets[j]->momentum).M(),weight); } }
						tempsize= pfBJetsLoose.size();
						for(int i=0;i<tempsize-1;i++){
							for(int j=i+1; j<tempsize;j++){ 
								lha2[s_EventTopology[iTopo]]["allMbb"][0]->Fill((pfBJetsLoose[i]->momentum+pfBJetsLoose[j]->momentum).M(),weight); } }
						}
						...
						for(std::vector<susy::PFJet*>::iterator it = ra3_pfjets.begin(); it != ra3_pfjets.end(); it++) {
							lha2[s_EventTopology[iTopo]]["jetPt"][0]->Fill((*it)->momentum.Pt(),weight);
							lha2[s_EventTopology[iTopo]]["jetEta"][0]->Fill((*it)->momentum.Eta(),weight);
							lha2[s_EventTopology[iTopo]]["jetPhi"][0]->Fill(phi_0_2pi((*it)->momentum.Phi() ),weight);
							lha2[s_EventTopology[iTopo]]["dPhiJetMet"][0]->Fill(phi_0_2pi(dPhi(metPhi,(*it)->momentum.Phi() )),weight);//
						}
						if (ra3_pfjets.size()>=2) {
							TLorentzVector j0 = ra3_pfjets[0]->momentum;
							TLorentzVector j1 = ra3_pfjets[1]->momentum;
							...
							//lha2[s_EventTopology[iTopo]]["dPhiJet0Met"][0]->Fill(phi_0_2pi(dPhi(metPhi,j0.Phi() )),weight);
							//lha2[s_EventTopology[iTopo]]["dPhiJet1Met"][0]->Fill(phi_0_2pi(dPhi(metPhi,j1.Phi() )),weight);

							lha2[s_EventTopology[iTopo]]["Mbb01"][0]->Fill(Mbb01,weight);
							lha2[s_EventTopology[iTopo]]["Mbb01gg01"][0]->Fill(Mbb01gg01,weight);
							lha2[s_EventTopology[iTopo]]["MJJ01gg01"][0]->Fill(MJJ01gg01,weight);
...
//						lha_MET[s_EventTopology[iTopo]][1]->Fill(corrmet,weight);
						...
						lha2[s_EventTopology[iTopo]]["phoPt1"][1]->Fill(p1.Pt(),weight);
						lha2[s_EventTopology[iTopo]]["phoPhi"][1]->Fill(phi_0_2pi(p0.Phi()),weight);
						lha2[s_EventTopology[iTopo]]["phoPhi"][1]->Fill(phi_0_2pi(p1.Phi()),weight);
						...
						for(int i=0;i<tempsize-1;i++){
							for(int j=i+1; j<tempsize;j++){
								lha2[s_EventTopology[iTopo]]["allMjj"][1]->Fill((ra3_pfjets[i]->momentum+ra3_pfjets[j]->momentum).M(),weight); } }
						tempsize= pfBJetsLoose.size();
						for(int i=0;i<tempsize-1;i++){
							for(int j=i+1; j<tempsize;j++){ 
								lha2[s_EventTopology[iTopo]]["allMbb"][1]->Fill((pfBJetsLoose[i]->momentum+pfBJetsLoose[j]->momentum).M(),weight); } }
						}
						...
						for(std::vector<susy::PFJet*>::iterator it = ra3_pfjets.begin(); it != ra3_pfjets.end(); it++) {
							lha2[s_EventTopology[iTopo]]["jetPt"][1]->Fill((*it)->momentum.Pt(),weight);
							lha2[s_EventTopology[iTopo]]["jetEta"][1]->Fill((*it)->momentum.Eta(),weight);
							lha2[s_EventTopology[iTopo]]["jetPhi"][1]->Fill(phi_0_2pi((*it)->momentum.Phi() ),weight);
							lha2[s_EventTopology[iTopo]]["dPhiJetMet"][1]->Fill(phi_0_2pi(dPhi(metPhi,(*it)->momentum.Phi() )),weight);//
						}
						if (ra3_pfjets.size()>=2) {
							TLorentzVector j0 = ra3_pfjets[0]->momentum;
							TLorentzVector j1 = ra3_pfjets[1]->momentum;
							...
							//lha2[s_EventTopology[iTopo]]["dPhiJet0Met"][1]->Fill(phi_0_2pi(dPhi(metPhi,j0.Phi() )),weight);
							//lha2[s_EventTopology[iTopo]]["dPhiJet1Met"][1]->Fill(phi_0_2pi(dPhi(metPhi,j1.Phi() )),weight);

							lha2[s_EventTopology[iTopo]]["Mbb01"][1]->Fill(Mbb01,weight);
							lha2[s_EventTopology[iTopo]]["Mbb01gg01"][1]->Fill(Mbb01gg01,weight);
							lha2[s_EventTopology[iTopo]]["MJJ01gg01"][1]->Fill(MJJ01gg01,weight);
						} //these will only make sense with the dijet topology.
						...
						lha2[s_EventTopology[iTopo]]["phoPt1"][2]->Fill(p1.Pt(),weight);
						lha2[s_EventTopology[iTopo]]["phoPhi"][2]->Fill(phi_0_2pi(p0.Phi()),weight);
						lha2[s_EventTopology[iTopo]]["phoPhi"][2]->Fill(phi_0_2pi(p1.Phi()),weight);
						...
						for(int i=0;i<tempsize-1;i++){
							for(int j=i+1; j<tempsize;j++){
								lha2[s_EventTopology[iTopo]]["allMjj"][2]->Fill((ra3_pfjets[i]->momentum+ra3_pfjets[j]->momentum).M(),weight); } }
						tempsize= pfBJetsLoose.size();
						for(int i=0;i<tempsize-1;i++){
							for(int j=i+1; j<tempsize;j++){ 
								lha2[s_EventTopology[iTopo]]["allMbb"][2]->Fill((pfBJetsLoose[i]->momentum+pfBJetsLoose[j]->momentum).M(),weight); } }
						}
						...
						for(std::vector<susy::PFJet*>::iterator it = ra3_pfjets.begin(); it != ra3_pfjets.end(); it++) {
							...
							lha2[s_EventTopology[iTopo]]["jetEta"][2]->Fill((*it)->momentum.Eta(),weight);
							lha2[s_EventTopology[iTopo]]["jetPhi"][2]->Fill(phi_0_2pi((*it)->momentum.Phi() ),weight);
							lha2[s_EventTopology[iTopo]]["dPhiJetMet"][2]->Fill(phi_0_2pi(dPhi(metPhi,(*it)->momentum.Phi() )),weight);//
						}
						if (ra3_pfjets.size()>=2) {
							TLorentzVector j0 = ra3_pfjets[0]->momentum;
							TLorentzVector j1 = ra3_pfjets[1]->momentum;
							...
							//lha2[s_EventTopology[iTopo]]["dPhiJet0Met"][2]->Fill(phi_0_2pi(dPhi(metPhi,j0.Phi() )),weight);
							//lha2[s_EventTopology[iTopo]]["dPhiJet1Met"][2]->Fill(phi_0_2pi(dPhi(metPhi,j1.Phi() )),weight);

							lha2[s_EventTopology[iTopo]]["Mbb01"][2]->Fill(Mbb01,weight);
							lha2[s_EventTopology[iTopo]]["Mbb01gg01"][2]->Fill(Mbb01gg01,weight);
							lha2[s_EventTopology[iTopo]]["MJJ01gg01"][2]->Fill(MJJ01gg01,weight);
						} //these will only make sense with the dijet topology.
	...
	for (int iTopo=0; iTopo<nEventTopologies; iTopo++) {
		...
		for (int kKinVar = 0; kKinVar<nKinemVars; kKinVar++) {
			...
			for (int i=0; i < 3; i++){ //don't write things with bkg or the bkg integral in them, handle that in postAnaAna
...
bool SusyMainAna_MC_arg_windowscan::ok_muon(std::vector<susy::Muon>::iterator it){ //Yu Feng
...
bool SusyMainAna_MC_arg_windowscan::ok_muon_AN_11_409(std::vector<susy::Muon>::iterator it,susy::Track& combinedTrack, float pVtx_Z){ //probably inner track instead
...
//	std::map<TString,UChar_t>::iterator idPair = it->idPairs.find("muidGlobalMuonPromptTight");
	...
	//use this one!
bool SusyMainAna_MC_arg_windowscan::ok_muon_DMoris(std::vector<susy::Muon>::iterator it_Mu,susy::Track& innerTrack){
	...
	//use this one!
bool SusyMainAna_MC_arg_windowscan::ok_ele(std::vector<susy::Electron>::iterator it_Ele){	//Dave Moris
...
bool SusyMainAna_MC_arg_windowscan::ok_ele_AN_11_409(std::vector<susy::Electron>::iterator it_Ele, susy::Track& innerTrack, float pVtx_Z){
		//if(!it_Ele->isPF() and !it_Ele->passingMvaPreselection()) return false;
	float pt=it_Ele->momentum.Pt();
...
float SusyMainAna_MC_arg_windowscan::JEC_MET(susy::MET* pfmet,std::vector<susy::PFJet*> ra3_pfjets,float &corrX, float &corrY, bool Debug_noisily){ 
...
float SusyMainAna_MC_arg_windowscan::PhoEC_MET(float oldcorrmet,std::vector<susy::Photon*> photons, float &corrX, float &corrY, bool Debug_noisily){
...
bool SusyMainAna_MC_arg_windowscan::ok_vtx(std::vector<susy::Vertex>::iterator it){
...
void SusyMainAna_MC_arg_windowscan::MakeHistSet(TH1F** h, string prefix, int nbins, float lower, float upper){
