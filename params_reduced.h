...
namespace params{
//data
string outroot_data = "/eos/uscms/store/user/abarker/SusyEvents_skim_data_D.root"; //skim of the events used in analysis form big ntuples
...
string plotsdir = "plots_sunil_350_n2n1_10x/";
...
const int nEventTopologies = 14; // the number of types of cuts selected, like 1JB...
	///warning: the EventTopology list must be the same for SusyMainAna and postanaana or you get nonsense.
string s_EventTopology[nEventTopologies] = {
"NULL","2JbMLm20", "2JbMLm20gbar1", "2JbMLm20gbar2","1lep","2lep",
...
"Tpho","2JbMLm20gbar2Tpho","1lepTpho","2lepTpho",
"2JbML!m20Gbar2Mbb", "2JbML!m20Gbar2Mbb!", "3JbMLLm20Gbar2", "4JbMLLLm20Gbar2"};
...
"HGt","HGt_prime","dPhiHG","dPhiHG_prime","HLMGt",
	...
	const int nKinemVars_limit = 21;
string s_KinemVars_limit[nKinemVars_limit] = {
"MET","ST","HT","MHT","PtGG",
"nJets","nLep","nMu","nEle","nBjets",
