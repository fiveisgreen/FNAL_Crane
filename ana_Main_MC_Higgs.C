...
void ana_Main_MC_Higgs(TString ds="relval", TString physics="ttbar") {
	...
	// Main analysis code
	gROOT->LoadMacro("SusyMainAna_Higgs.cc+");
	...
	cout<<"Trying to grab file at filepath: "<<endl;
	cout<<thisMCpoint->filepath.c_str()<<endl;
	...
	SusyMainAna_Higgs* sea = new SusyMainAna_Higgs(chain);
