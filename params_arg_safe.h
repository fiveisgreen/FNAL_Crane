...
const int nEventTopologies = 15; // the number of types of cuts selected, like 1JB...
...
const int nKinemVars_all = 39;		//always keep MET in the first position, it's special.
