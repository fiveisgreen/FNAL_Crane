...
hMET2JbMLm20gbar2_MC->Draw();
TLegend * l = new TLegend(0.405779,0.68956  ,0.605528,0.888736);
PrettyLegend(l);
l->AddEntry(hMET2JbMLm20gbar2_MC,"Unshifted");
PrettyHist(hMET2JbMLm20gbar2_BtagEffUp,kRed);
hMET2JbMLm20gbar2_BtagEffUp->Draw("same");
l->AddEntry(hMET2JbMLm20gbar2_BtagEffUp,"Btag Efficiency Up 1#sigma");
PrettyHist(hMET2JbMLm20gbar2_BtagEffDown,kBlue);
l->AddEntry(hMET2JbMLm20gbar2_BtagEffDown,"Btag Efficiency Down 1#sigma");
hMET2JbMLm20gbar2_BtagEffDown->Draw("same");
hMET2JbMLm20gbar2_MC->Draw("same");
l->Draw("same");
c->SaveAs("BtagEffcomp_mst_210_mu_150.pdf");
c->SaveAs("BtagEffcomp_mst_210_mu_150.jpg");
