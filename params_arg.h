...
const int nKinemVars_all = 58;		//always keep MET in the first position, it's special.
...
"phobDPhiMax",
"PtBB",
"PtGGPtBB"}; //are we getting gJets with one pho directly bk to bk with one of the jets? 
