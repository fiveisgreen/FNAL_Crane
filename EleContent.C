...
void EleContent(){
	CMSStyle();
	TFile* Fpvpv = TFile::Open("plotsWithBackground_dataGLL12_PVPV.root");
	TFile* Felepho=TFile::Open("plotsWithBackground_dataGLL12_ElePho.root");
	TFile* Feleele=TFile::Open("plotsWithBackground_dataGLL12_EleEle.root");

	TH1F* h_pvpv_pt = (TH1F*)Fpvpv->Get("hphoPt02JbMLgbar2_bkg");
	TH1F* h_elepho_pt = (TH1F*)Felepho->Get("hphoPt02JbMLgbar2_bkg");
	TH1F* h_eleele_pt = (TH1F*)Feleele->Get("hphoPt02JbMLgbar2_bkg");

	TH1F* h_pvpv_met = (TH1F*)Fpvpv->Get("hMET2JbMLgbar2_bkg");
	TH1F* h_elepho_met = (TH1F*)Felepho->Get("hMET2JbMLgbar2_bkg");
	TH1F* h_eleele_met = (TH1F*)Feleele->Get("hMET2JbMLgbar2_bkg");
	...
	TLegend * ll = new TLegend(0.54397,0.708791,0.743719,0.907967);
	PrettyLegend(ll);
