 ...
 */
	...
	// $Id: SusyAna_firstskim.cc,v 1.12 2012/05/03 19:58:51 dwjang Exp $
	//

#define SusyAna_firstskim_cxx
...
void SusyAna_firstskim::InitializePerEvent() {
	
}


bool SusyAna_firstskim::isSameObject(TLorentzVector& p1, TLorentzVector& p2) {
...
float SusyAna_firstskim::d0correction(TVector3& beamSpot, susy::Track& track) const {
...
bool SusyAna_firstskim::PassTrigger(TString path) {
	bool pass = false;
...
bool SusyAna_firstskim::PassTriggers() {
	bool pass = false;
