...
// Class:      SusyEventAnalyzer_shruti.cc
// 
/*
...
// $Id: SusyEventAnalyzer_shruti.cc,v 1.15 2012/08/31 11:33:53 bfrancis Exp $
//
...
void SusyEventAnalyzer_shruti::Loop() {
	...
	TH1F* phoPt = new TH1F("phoPtplot","raw photon Pt with no quality cuts",150,0,150);
	...
	std::cout << " myNevents               : " << nCnt[10] << " (" << nCnt[10]/float(nCnt[1]) << ")" << std::endl;
	std::cout << " myNevents with pho map  : " << nCnt[11] << " (" << nCnt[11]/float(nCnt[1]) << ")" << std::endl;
