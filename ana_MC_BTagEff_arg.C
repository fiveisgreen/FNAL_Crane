...
void ana_MC_BTagEff_arg(string which_MC_to_use, string MCFileLocation) { 
  ...
  // Main analysis code
  gROOT->LoadMacro("SusyAna_MC_BTagEff_arg.cc+"); //this line causes everything to segfault at the end.
...
//////////////// MC files /////////////////
  ...
  cout<<"trying to open source data file at location "<<MCFileLocation<<endl;
...
*/
  ...
  SusyAna_MC_BTagEff_arg* sea = new SusyAna_MC_BTagEff_arg(chain);
