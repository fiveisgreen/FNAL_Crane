...
void ana_MC_phoEff(TString ds="relval", TString physics="ttbar") {
{
  ...
  // Main analysis code
  gROOT->LoadMacro("SusyAna_MC_phoEff.cc+"); //this line causes everything to segfault at the end.
...
*/
  ...
  SusyAna_MC_phoEff* sea = new SusyAna_MC_phoEff(chain);
