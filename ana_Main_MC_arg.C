...
void ana_Main_MC_arg(string which_MC_to_use, string MCFileLocation) {
	...
	// Main analysis code
	gROOT->LoadMacro("SusyMainAna_MC_arg.cc+");
	...
	SusyMainAna_MC_arg* sea = new SusyMainAna_MC_arg(chain);
