	...
	// Class:      SusyMainAna_MC_arg_windowscan.h
	// 
/*
 ...
 */
	...
	// $Id: SusyMainAna_MC_arg_windowscan.h,v 1.4 2011/06/08 16:28:40 dmason Exp $
	//

#ifndef SusyMainAna_MC_arg_windowscan_h
#define SusyMainAna_MC_arg_windowscan_h
...
class SusyMainAna_MC_arg_windowscan {
	public :
	...
	SusyMainAna_MC_arg_windowscan(TTree *tree=0);
	virtual ~SusyMainAna_MC_arg_windowscan();
...
#ifdef SusyMainAna_MC_arg_windowscan_cxx
SusyMainAna_MC_arg_windowscan::SusyMainAna_MC_arg_windowscan(TTree *tree)
{
	if (tree == 0) {
...
SusyMainAna_MC_arg_windowscan::~SusyMainAna_MC_arg_windowscan()
{
	if (!fChain) return;
	delete fChain->GetCurrentFile();
}

Int_t SusyMainAna_MC_arg_windowscan::GetEntry(Long64_t entry)
{
		// Read contents of entry.
	if (!fChain) return 0;
	return fChain->GetEntry(entry);
}
Long64_t SusyMainAna_MC_arg_windowscan::LoadTree(Long64_t entry)
{
...
void SusyMainAna_MC_arg_windowscan::Init(TTree *tree)
{
	if (!tree) return;
	fChain = tree;
	fCurrent = -1;
...
void SusyMainAna_MC_arg_windowscan::Initialize() {
...
void SusyMainAna_MC_arg_windowscan::IncludeAJson(std::string jsonfile) {
...
bool SusyMainAna_MC_arg_windowscan::isInJson(Int_t run,Int_t lumi) {
...
#endif // #ifdef SusyMainAna_MC_arg_windowscan_cxx
