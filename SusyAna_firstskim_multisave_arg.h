...
// Class:      SusyAna_firstskim_multisave_arg.h
// 
/*
...
// $Id: SusyAna_firstskim_multisave_arg.h,v 1.4 2011/06/08 16:28:40 dmason Exp $
//

#ifndef SusyAna_firstskim_multisave_arg_h
#define SusyAna_firstskim_multisave_arg_h
...
class SusyAna_firstskim_multisave_arg {
 public :
  ...
  SusyAna_firstskim_multisave_arg(TTree *tree=0);
  virtual ~SusyAna_firstskim_multisave_arg();
...
#ifdef SusyAna_firstskim_multisave_arg_cxx
SusyAna_firstskim_multisave_arg::SusyAna_firstskim_multisave_arg(TTree *tree)
{
  if (tree == 0) {
...
SusyAna_firstskim_multisave_arg::~SusyAna_firstskim_multisave_arg()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t SusyAna_firstskim_multisave_arg::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t SusyAna_firstskim_multisave_arg::LoadTree(Long64_t entry)
{
...
void SusyAna_firstskim_multisave_arg::Init(TTree *tree)
{
  if (!tree) return;
  fChain = tree;
  fCurrent = -1;
...
void SusyAna_firstskim_multisave_arg::Initialize() {
...
void SusyAna_firstskim_multisave_arg::IncludeAJson(std::string jsonfile) {
...
bool SusyAna_firstskim_multisave_arg::isInJson(Int_t run,Int_t lumi) {
...
#endif // #ifdef SusyAna_firstskim_multisave_arg_cxx
