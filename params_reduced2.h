...
int bumpBtagEff = -1;//is allowed to be +- 1 and 0 
...
const int nEventTopologies = 8; // the number of types of cuts selected, like 1JB...
...
"NULL","2JbMLm20", "2JbMLm20gbar1", "2JbMLm20gbar2",
