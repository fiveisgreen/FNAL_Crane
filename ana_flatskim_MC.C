...
void ana_flatskim_MC(TString ds="relval", TString physics="ttbar") {
...
bool useC1 = true;// /eos/uscms/store/user/lpcpjm/SusyNtuples/cms525v3_jec2012/Run2012C-PromptReco-v1/DoublePhoton/Runs198022-198903/
bool useC2 = true;// /eos/uscms/store/user/lpcpjm/SusyNtuples/cms525v3_jec2012/Run2012C-PromptReco-v2/DoublePhoton/Runs198941-199103/
//sea->IncludeAJson("Cert_190456-199429_8TeV_PromptReco_Collisions12_JSON.txt");

bool useC3 = true;// /eos/uscms/store/user/lpcpjm/SusyNtuples/cms525v3_jec2012/Run2012C-PromptReco-v2/DoublePhoton/Runs199275-200190/
bool useC4 = true;// /eos/uscms/store/user/lpcpjm/SusyNtuples/cms525v3_jec2012/Run2012C-PromptReco-v2/DoublePhoton/Runs200228-200601/
bool useC5 = true;// /eos/uscms/store/user/lpcpjm/SusyNtuples/cms525v3_jec2012/Run2012C-PromptReco-v2/DoublePhoton/Runs200781-202016/
...
useC4 = false;
useC5 = false;
//chain->Add("Tripathi_events_MC.root");
//chain->Add("susyEvents_20k.root");
   chain->Add("/eos/uscms/store/user/lpcpjm/PrivateMC/FastSim/533p3_full/naturalHiggsinoNLSP/SusyNtuple/cms533v1_v1/tree_naturalHiggsinoNLSPout_mst_350_M3_5025_mu_225.root");
}
