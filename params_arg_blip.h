...
//Limit Setting
bool remake_Limit_packages = false;
bool remake_Limit_cards    = false;
...
const int nEventTopologies = 43; // the number of types of cuts selected, like 1JB...
string s_EventTopology[nEventTopologies] = { 
	...
	"23JbML!gbar2Mbb01lep", "2JbML!gbar2Mbb01lep",//2
	"2lJgbar2", "2lJewkMllgbar2", "23lJewkMllgbar2", //"2lJMWgbar2", "2lJMZgbar2", //4
...
const int nEventTopologies_limit = 30; // the number of types of cuts selected, like 1JB...
string s_EventTopology_limit[nEventTopologies_limit] = {
	...
	"23JbML!gbar2Mbb0lep", "2JbML!gbar2Mbb0lep", //2
	"2JbML!Gbar2Mbb","2JbMM!Gbar2Mbb","2JbML!gbar2bestOn","2JbMM!gbar2bestOn",//4
	"2lJgbar2", "2lJewkMllgbar2", "23lJewkMllgbar2",//"2lJMWgbar2", "2lJMZgbar2", //4
	"2JbML","2JbMLgbar2", "2JbMMgbar2", //3
	"2JbT!gbar2ProbeMJJ",
...
const int nKinemVars_all = 48;		//always keep MET in the first position, it's special.
...
float mHiggs = 136.f; //higgs mass. 
float mHwidth = 5.f; //width of the tag region 5 gives 80%, 7 is probably too broad, but brings it up to 86
float l_tag_sb_gap = 3.0f;//lower sideband gap
float u_tag_sb_gap = 3.0f;//upper sideband gap
//float l_sidebandwidth = 25.f;//lower sideband width
//float u_sidebandwidth = 49.f;//upper sideband width
float l_sidebandwidth = (mHiggs - 0.5*mHwidth - l_tag_sb_gap) -  105.0;//lower sideband width
float u_sidebandwidth = 180 - (mHiggs + 0.5*mHwidth + u_tag_sb_gap);//lower sideband width
