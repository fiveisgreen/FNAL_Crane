...
void ana_winscan_data(TString ds="relval", TString physics="ttbar") {
  ...
  // Main analysis code
  gROOT->LoadMacro("SusyMainAna_windowscan.cc+");
...
bool useSkim = true; //use just the medium skin. 
...
//}
  ...
  SusyMainAna_windowscan* sea = new SusyMainAna_windowscan(chain);
