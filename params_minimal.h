...
const int nKinemVars_all = 17;		//always keep MET in the first position, it's special.
string s_KinemVars_all[nKinemVars_all] = {
"MET","ST","HT","MHT","PtGG",
"phoEta","phoEtaMax","nJets","nMu", "nBjets",
"jetPt","dijetM01",
"Bt","bestMjj","bestMbb","Mbb01","BTT"};
