...
set label = mst_185_mu_150
set floc = dcache:/pnfs/cms/WAX/resilient/lpcpjm/PrivateMC/FastSim/533p3_full/naturalHiggsinoNLSP_try4/SusyNtuple/cms533v1_v1/tree_naturalHiggsinoNLSPout_mst_185_M3_5050_mu_150.root raw
set rroot = raw_plots_MC_st185_ho150.root 
set rlog = raw_plots_MC_st185_ho150.log 
set proot = plotsWithBackground_MC_st185_ho150.root 
set plog = plotsWithBackground_MC_st185_ho150.log
